...
select = st.sidebar.selectbox('Visualization type', ['Bar plot', 'Pie chart'], key='viz_type_select')
...
if not st.sidebar.checkbox("Close", True, key='close_time_location'):
...
each_airline = st.sidebar.selectbox('Visualization type', ['Bar plot', 'Pie chart'], key='airline_viz_type')
...
if not st.sidebar.checkbox("Close", True, key='close_airline_total'):
...
if len(choice) > 0:
    ...
    breakdown_type = st.sidebar.selectbox('Visualization type', ['Pie chart', 'Bar plot'], key='breakdown_viz_type')
